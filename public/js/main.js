(function($) {
    ...
    function mobileHeaderActive() {
        ...
        // Close mobile menu on end trigger click
    ...
    // /* Add Toggle Button With Off Canvas Menu */
    // $offCanvasNav.find("li").prepend('<span class="menu-expand"><svg class="w-6 h-6 icon-16" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.7911 1.0474C15.5023 0.741097 15.0192 0.729691 14.7145 1.01768L7.99961 7.37897L1.28555 1.01772C0.980773 0.728941 0.498472 0.741128 0.208947 1.04743C-0.080577 1.35296 -0.0676398 1.83526 0.237916 2.12478L7.47618 8.98209C7.62246 9.12077 7.81143 9.19087 7.99961 9.19087C8.18779 9.19087 8.37751 9.12077 8.52382 8.98209L15.7621 2.12478C16.0676 1.83523 16.0806 1.35296 15.7911 1.0474Z" fill="#181A1F"/></svg></span>');

    // /* Close Off Canvas Menu */
    // $offCanvasNav.find("ul").hide();
    ...
    //         e.preventDefault();
    //         $this.toggleClass("active").siblings().removeClass("active").find("li").removeClass("active");
