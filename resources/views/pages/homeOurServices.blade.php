<section class="section pt-90 pb-120 bg-our-service">
    ...
    <div class="container-sub">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-sm-5 col-5 text-end"><a
                    class="text-16-medium color-primary d-flex align-items-center justify-content-end wow fadeInUp"
                    href="#">More Services

                    <svg class="icon-16 ml-5" fill="none" stroke="currentColor" stroke-width="1.5" viewbox="0 0 24 24"
                        ...
                        <div class="cardService wow fadeInUp">
                            ...
                            <div class="cardInfo">
                                ...
                                <div class="box-inner-info">
                                    ...
                                    <p class="cardDesc text-14 color-white mb-30">Mercedes-Benz E-Class, BMW 5 Series,
                                        Cadillac XTS or similar</p><a class="cardLink btn btn-arrow-up"
                                        href="{{ url('/intercityRideService') }}">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="cardService wow fadeInUp">
                            ...
                            <div class="cardInfo">
                                ...
                                <h3 class="cardTitle text-20-medium color-white mb-10">Ground Transportation Service
                                </h3>
                                ...
                                <div class="box-inner-info">
                                    ...
                                    <p class="cardDesc text-14 color-white mb-30">Mercedes-Benz E-Class, BMW 5 Series,
                                        Cadillac XTS or similar</p><a class="cardLink btn btn-arrow-up"
                                        href="{{ url('/groundTransportationService') }}">
                        ...
                        <div class="cardService wow fadeInUp">
                            ...
                            <div class="cardInfo">
                                ...
                                <div class="box-inner-info">
                                    ...
                                    <p class="cardDesc text-14 color-white mb-30">Mercedes-Benz E-Class, BMW 5 Series,
                                        Cadillac XTS or similar</p><a class="cardLink btn btn-arrow-up"
                                        href="{{ url('/airportTransportService') }}">
