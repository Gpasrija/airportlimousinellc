      ...
      <div class="container-sub"> 
        ...
        <div class="box-breadcrumb"> 
          <ul>
            ...
            <li><a href="{{ url('/citylist') }}">Cities</a></li>
          </ul>
        </div>
      </div>
    </div>
    <section class="section pt-60">
      <div class="container-sub"> 
        <div class="text-center"> 
          <h2 class="color-brand-1 mb-20">Cities we serve</h2>
        </div>
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6 mb-30"> 
            <div class="cardService wow fadeInUp">
               <div class="cardCityInfo">
                 <h3 class="cardTitle text-20-medium color-white mb-10">Indianapolis</h3>
                 <div class="box-inner-info">
                   <ul class="cardDesc1 text-14 color-white mb-30">
                     <li><b>*University of IndianaPolis</b></li>
                     <li><b>*Distance from IND*: </b>Approx 18 miles (29 km)</li>
                     <li><b>*Special Info*: </b> With more than 250 undergraduate majors and graduate degree programs, IU Indianapolis is one of the nation's premier urban research universities.</li>
                   </ul>
                 </div>
               </div>
               <div class="cardImage"><img src="/imgs/page/cities/indianapolis.jpeg" alt="Luxride"></div>
             </div>
           </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-6 mb-30"> 
            <div class="CityInfo">
              <h3 class="cityTitle text-20-medium mb-10">{{ $city }}</h3>
            </div>
          </div>
          @endforeach
        </div>
