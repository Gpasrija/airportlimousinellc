@extends('layouts.app')
@section('meta')
    <meta name="description" content="Enjoy premium intercity ride services across Indiana. From city-to-city transport to long-distance travel, we provide luxurious rides with exceptional comfort and professionalism.">
    <meta name="keywords" content="intercity ride services, city-to-city transportation, long-distance travel, luxury transport Indiana, intercity limousine service">
    <meta property="og:title" content="Intercity Luxury Ride Services | Airport Limousine LLC">
    <meta property="og:description" content="Enjoy premium intercity ride services across Indiana. From city-to-city transport to long-distance travel, we provide luxurious rides with exceptional comfort and professionalism.">
    {{-- <meta property="og:image" content="{{ asset('images/home-page-image.jpg') }}"> --}}
    <meta property="og:url" content="{{ url()->current() }}">
@endsection
@section('title', 'Intercity Luxury Ride Services | Airport Limousine LLC')
